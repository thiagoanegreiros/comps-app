...
export const DialogDemo = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center gap-6 p-6">
      <h1 className="text-3xl font-bold text-blue-600">Dialog Component Demo</h1>
      ...
      <Dialog
        ...
        isModal={true}
        header={<h2 className="text-xl font-semibold text-center">Confirm Action</h2>}
        body={<p className="text-gray-600 text-center">Are you sure you want to remove this team?</p>}
        footer={
          <div className="flex justify-center gap-4">
            <button className="px-4 py-2 rounded bg-gray-300" onClick={confirmDialog.close}>No</button>
            <button className="px-4 py-2 rounded bg-red-500 text-white" onClick={() => { confirmDialog.close(); alert("Deleted"); }}>Yes</button>
          </div>
        }
      />
